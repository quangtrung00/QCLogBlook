<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Calendar.ascx.cs" Inherits="Pub_Module_Calendar_Old" %>
...
function ShowCanlendar(objThis,strFormat)
{
	...
	var tmpPath = "http://" + aStrName[2] + "/" + aStrName[3] + "/";
...
<asp:TextBox id="UC_Calendar"  onchange="ValidData1(this);" runat="server" Width="78px" MaxLength="10"></asp:TextBox>
<input type="button" id="btn1ByCalendar" value="..." onclick="ShowCanlendar(this,'yyyymmdd');">