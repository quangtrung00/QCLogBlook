<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyAccount.aspx.cs" Inherits="Pub_Module_ApplyAccount" %>

<%@ Register Src="ValidNumber.ascx" TagName="ValidNumber" TagPrefix="uc1" %>
					...
					<td valign="top" style="PADDING-RIGHT: 0px; BACKGROUND-POSITION: left top; PADDING-LEFT: 300px; BACKGROUND-IMAGE: url(../../images/number_1.jpg); PADDING-BOTTOM: 0px; PADDING-TOP: 80px; BACKGROUND-REPEAT: no-repeat">
						<table cellpadding="0" cellspacing="0" border="0">
							...
							<tr style="LINE-HEIGHT:2">
								...
								<td>
                                    <uc1:ValidNumber ID="ValidNumber1" runat="server"  CssClass="inputTxt02" />
                                </td>
							</tr>
							<tr>
								<td colspan="2" align=center style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:0px; PADDING-TOP:20px">
