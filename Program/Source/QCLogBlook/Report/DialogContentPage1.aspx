<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DialogContentPage1.aspx.cs" Inherits="DialogContentPage" %>
...
<head runat="server">
    ...
    <script src="../../Pub/Js/DemoScript.js" type="text/javascript"></script>
    <style type="text/css">
        .style1
        {
            width: 100%;
        ...
        <div>
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlDeptNo" onchange="OnchangeDept(this)"  runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
